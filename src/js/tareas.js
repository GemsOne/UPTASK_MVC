(function() {
    ...
    function mostrarTareas() {
        ...
        arrayTareas.forEach(tarea => {
            ...
            const btnEliiminarTarea = document.createElement('BUTTON');
            btnEliiminarTarea.classList.add('eliminar-tarea');
            btnEliiminarTarea.dataset.idTarea = tarea.id;
            btnEliiminarTarea.textContent = 'Eliminar';
            btnEliiminarTarea.ondblclick = function() {
                confirmarEliminarTarea({...tarea});
            }

            opcionesDiv.appendChild(btnEstadoTarea);
            opcionesDiv.appendChild(btnEliiminarTarea);
            ...
            <form class="formulario nueva-tarea">
                ...
                <div class="campo">
                    ...
                    <input
                        type="text"
                        name="tarea"
                        placeholder="${tarea.nombre ? 'Edita la Tarea' : 'Agrega una Tarea al Proyecto Actual'}" 
                        id="tarea"
    ...
    // Consultar el Servidor para agg una nueva tarea al proyecto actual
